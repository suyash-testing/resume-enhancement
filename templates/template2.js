...
export const generateDocx = async (extractedData) => {
  const imageUrl =
    "https://images.pexels.com/photos/28663140/pexels-photo-28663140/free-photo-of-abstract-artistic-textured-surface-in-cool-tones.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1";
        ...
        children: [
          ...
          extractedData?.workExperience?.length
            ? new Paragraph({
                ...
                border: {
                  bottom: {
                    color: "000000", // Black color for the border
                    space: 1,
                    value: "single", // Single solid line
                    size: 6, // Reduced thickness of the border
                  },
                },
                children: [
                  new TextRun({
            ...
            : null,
          ...(extractedData?.workExperience?.flatMap((exp, index) => [
            exp?.Organization
              ? new Paragraph({
                  children: [
                    new TextRun({
          ...
          extractedData?.projects?.length
            ...
            : null,
          ...(extractedData?.projects?.flatMap((proj) => [
            proj?.project
              ? new Paragraph({
                  children: [
                    new TextRun({
